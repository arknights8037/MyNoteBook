...
pub(crate) const SIGNAL_AGENT_RETRY_POLICY: RetryPolicy =
    RetryPolicy::new(3, 5_000, 5 * 60 * 1_000);
pub(crate) const ACTION_GATEWAY_RETRY_POLICY: RetryPolicy =
    RetryPolicy::new(5, 5_000, 15 * 60 * 1_000);
