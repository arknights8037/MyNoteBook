import { createDefaultWorkspaceViewPayload, type StructuredWorkspaceViewPayload, type StructuredWorkspaceViewType, type WorkspaceViewOperation, applyWorkspaceViewOperation } from '@/models/workspace/workspaceView'
