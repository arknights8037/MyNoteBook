...
export const THEME_DEFINITIONS: Record<ThemeId, ThemeDefinition> = {
  ...
  'nord-dark': {
    ...
    colors: {
      ...
      agent: {
        ...
        thinkingBackground: '#2E4148',
        suggestionBackground: '#2B3B42',
  ...
  'graphite-dark': {
    ...
    colors: {
      ...
      agent: {
        accent: '#79AFCB',
        panelBackground: '#181B20',
        messageBackground: '#20242A',
        thinkingBackground: '#1C2A32',
        suggestionBackground: '#18252C',
        citationBackground: '#17303A',
      },
      diff: {
