...
import { THEME_DEFINITIONS, type ThemeDefinition } from '@/services/appearance/themeDefinitions'
...
export {
  ...
  type ThemeFamily,
  type ThemeMode,
} from '@/services/appearance/themeDefinitions'
