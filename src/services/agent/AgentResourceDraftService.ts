...
import type { McpServerConfig, McpTransport } from '@/models/integrations/mcp'
import type { InstalledSkill } from '@/models/integrations/skill'
import type { CreateAutomationCommand } from '@/services/automation/AutomationService'
